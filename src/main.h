...
static const int STAKE_TARGET_SPACING = 60; // 60 seconds block spacing 
...
public:
    ...
    */
	...
	//IY
    bool ReadFromDisk(CTxDB& txdb, const uint256& hash, CTxIndex& txindexRet); // ORPHAN BLOCKS ELIMINATOR
...
public:
    ...
    {
        // Protocol switch to support p2pool at LEOcoin block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before LEOcoin block #9689 - old protocol
