...
# Template: app
# Command: c:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile LEOcoin-qt.pro
#############################################################################
...
Makefile: LEOcoin-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile LEOcoin-qt.pro
...
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\leo_pos\leocoin-qt_plugin_import.cpp
